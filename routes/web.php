...
Route::group(['middleware' => 'language', 'prefix' => "admin-panel", 'namespace' => "Admin"], function ($router) {
    ...
    Route::resource('points_packages', 'PointsPackageController');
    Route::post('points_packages/update', 'PointsPackageController@update')->name('points_packages.update');
    Route::post('points_packages/update_points/settings', 'PointsPackageController@update_points')->name('update.points.settings');
    Route::get('points_packages/delete/{id}', 'PointsPackageController@destroy')->name('points_packages.delete');
