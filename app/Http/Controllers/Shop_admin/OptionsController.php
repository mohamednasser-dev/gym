...
class OptionsController extends Controller{
    ...
    public function show(){
        ...
        return view('shop_admin.options.options' , ['data' => $data]);
    }
    ...
    public function show_properties_categories(){
        ...
        return view('shop_admin.options.options_categories' , ['data' => $data]);
    }
    ...
    public function addGet() {
        ...
        return view('shop_admin.options.option_form', ['data' => $data]);
    }

    // add get properties category
    public function addGetPropertyCategory() {
        return view('shop_admin.options.options_category_form');
    }
    ...
    public function editGet(Option $option) {
        ...
        return view('shop_admin.options.option_edit', ['data' => $data]);
    }
    ...
    public function editGetPropertiesCategory(PropertiesCategory $category) {
        ...
        return view('shop_admin.options.options_category_edit', ['data' => $data]);
    }
