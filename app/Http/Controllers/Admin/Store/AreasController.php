...
class AreasController extends AdminController{
    ...
    public function show(){
        ...
        return view('store.area.areas' , ['data' => $data]);
    }

    // add get
    public function addGet() {
        $data['governorates'] = Governorate::where('deleted', 0)->get();
        return view('store.area.area_form', compact('data'));
    }
    ...
    public function EditGet(Area $area){
        $data['area'] = $area;
        $data['governorates'] = Governorate::where('deleted', 0)->get();
        return view('store.area.area_edit' , ['data' => $data ]);
    }
    ...
    public function details(Area $area) {
        $data['area'] = $area;
        // dd($data['area']->stores);
        return view('store.area.area_details', ['data' => $data]);
    }
    ...
    public function getAddDeliveryByArea($area) {
        ...
        return view('store.area.deliver_cost_areas_form', compact('data'));
    }
    ...
    public function getAddDeliveryByGovernorate($governorate) {
        ...
        return view('store.area.deliver_cost_governorates_form', compact('data'));
    }
    ...
    public function deliver_cost_areas() {
        ...
        return view('store.area.deliver_cost_areas', compact('data'));
    }
    ...
    public function addDeliveryCostByGovernorate() {
        ...
        return view('store.area.deliver_cost_governorates', compact('data'));
    }
    ...
    public function show_delivery_costs(Area $area) {
        ...
        return view('store.area.delivery_costs', ['data' => $data]);
    }
    ...
    public function edit_delivery_cost_get(Area $area, DeliveryArea $cost) {
        ...
        return view('store.area.deliver_cost_edit', ['data' => $data]);
    }
    ...
    public function getGovernorates() {
        ...
        return view('store.area.governorates', compact('data'));
    }
    ...
    public function getEditGovernorate(Governorate $governorate) {
        ...
        return view('store.area.governorate_edit', compact('data'));
    }
    ...
    public function getGovernorateDetails(Governorate $governorate) {
        ...
        return view('store.area.governorate_details', compact('data'));
    }
