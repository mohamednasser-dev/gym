            ...
            <div style="margin-bottom: 50px" class="widget-header">
                ...
                <div class="col-md-12">
                    <div class="mx-auto center-block add-prod-container text-center">
                        ...
                        @if (isset($data['cat']))
                        <a href="{{ route('products.add') . '?cat=' . $data['cat'] }}" class="btn btn-warning">{{ __('messages.add_new_product') }}</a>
                        @else
                        <a href="{{ route('products.add') }}" class="btn btn-warning">{{ __('messages.add_new_product') }}</a>
                        @endif
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="widget-content widget-content-area col-md-3">
                    <div class="card component-card_2">
                        <img src="https://res.cloudinary.com/dezsm0sg7/image/upload/w_250,h_250,q_100/v1581928924/{{ isset($product->images[0]) ? $product->images[0]->image : '' }}" class="card-img-top" alt="widget-card-2">
                        <div class="card-body">
