...
@push('scripts')
    <script>
        ...
        $("#category").on("change", function () {
            ...
            $.ajax({
                url : "/store-panel/products/fetchsubcategorybycategory/" + categoryId,
                type : 'GET',
    ...
    <div id="badgeCustom" class="col-lg-12 mx-auto layout-spacing">
        <div class="statbox widget prod-search box box-shadow">
            <div id="tableSimple" class="col-lg-12 col-12 layout-spacing">
                    ...
                    <form class="form-inline my-2 my-lg-0 justify-content-center">
                        <div class="w-100">
                            <input type="text" class="w-100 form-control product-search br-30" id="input-search"
                                   name="name" placeholder="{{ __('messages.search_for_product_name') }}">
                ...
                <h5 style="cursor: pointer; color: #FFF"
                    class="text-center search-manually">{{ __('messages.or_search_manually') }}</h5>
                    ...
                    <form id="manual_search" action="{{ route('products.getbysubcat') }}">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <select required id="category" name="cat" class="form-control">
