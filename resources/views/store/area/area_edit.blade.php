                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title_ar" class="form-control" id="title_ar"
                               placeholder="{{ __('messages.title_ar') }}" value="{{ $data['area']['title_ar'] }}">
                    </div>
                    <div class="form-group mb-4">
                        <label for="title_en">{{ __('messages.title_en') }}</label>
                        <input required type="text" name="title_en" class="form-control" id="title_en"
                               placeholder="{{ __('messages.title_en') }}" value="{{ $data['area']['title_en'] }}">
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select id="seller_id" name="governorate_id" class="form-control">
                            ...
                            @foreach ( $data['governorates'] as $governorate )
                                <option
                                    {{ $data['area']['governorate_id'] == $governorate->id ? 'selected' : '' }} value="{{ $governorate->id }}">{{ App::isLocale('en') ? $governorate->title_en : $governorate->title_ar }}</option>
                            @endforeach
                        </select>
                    </div>
