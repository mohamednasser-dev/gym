                        ...
                        @foreach ($data['shops'] as $shop)
                            <tr>
                                ...
                                @if(Auth::user()->delete_data)
                                    @if($shop->status == 1)
                                    <td class="text-center blue-color" >
                                        <a onclick='return confirm("{{ __('messages.are_you_sure') }}");' href="{{ route('shops.action', [$shop->id, 2]) }}" ><span class="badge badge-danger">{{ __('messages.block') }}</span></a>
                                    </td>
                                    @else
                                    <td class="text-center blue-color" >
                                        <a onclick='return confirm("{{ __('messages.are_you_sure') }}");' href="{{ route('shops.action', [$shop->id, 1]) }}" >
