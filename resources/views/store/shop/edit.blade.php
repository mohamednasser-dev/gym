    ...
    <div class="col-lg-12 col-12 layout-spacing">
        ...
        <form action="" autocomplete="do-not-show-ac" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group mb-4">
                ...
                <input required type="text" name="name_ar" class="form-control" id="email" placeholder="{{ __('messages.name_ar') }}" value="{{$data['store']['name_ar']}}" >
            </div>
            <div class="form-group mb-4">
                <label for="email">{{ __('messages.name_en') }}</label>
                <input required type="text" name="name_en" class="form-control" id="email" placeholder="{{ __('messages.name_en') }}" value="{{$data['store']['name_en']}}" >
            </div>
            <div class="form-group mb-4">
                <label for="email">{{ __('messages.phone') }}</label>
                <input required type="text" name="phone" class="form-control" id="phone" placeholder="{{ __('messages.phone') }}" value="{{$data['store']['phone']}}" >
            </div>
            <div class="form-group mb-4">
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" step="any" min="0" name="min_order_cost" class="form-control" id="min_order_cost" placeholder="{{ __('messages.min_order_cost') }}" value="{{ $data['store']['min_order_cost'] }}" >
            </div>
            <div class="form-group mb-4">
