        ...
        <div class="statbox widget box box-shadow">
            ...
            <div class="widget-content widget-content-area">
                <div class="form-group col-md-3">
                    <form id="paymentForm" method="post" action="{{ route('hall_payments.fetch_by_booking') }}">
                        @csrf
                        <label for="payment_select">{{ __('messages.search_with_booking') }}</label>
                        <select required id="payment_select" name="booking_id" class="form-control">
                ...
                <div class="table-responsive">
                    <table id="order-tbl" class="table table-hover non-hover" style="width:100%">
                        ...
                        <tr>
                            ...
                            <th class="text-center blue-color">{{ __('messages.payment_method') }}</th>
                            <th class="text-center blue-color">{{ __('messages.booking_name') }}</th>
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td class="text-center blue-color">{{ $row->payment }}</td>
                                <td class="text-center blue-color">@if(app()->getLocale() == 'ar' ) {{ $row->Booking->name_ar }} @else {{ $row->Booking->name_en }} @endif</td>
