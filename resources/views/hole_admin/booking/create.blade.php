            ...
            <form method="post" action="{{route('booking.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-md-4">
                        ...
                        <div class="form-check pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input type="checkbox" class="custom-control-input" name="cb_discount" value="discount" id="discount">
                    ...
                    <div class="col-md-4" id="discount_price_cont" style="display: none;">
                        ...
                        <input  type="number" step="any" readonly id="txt_discount_price" name="discount_price" class="form-control">
                    </div>
                </div>
