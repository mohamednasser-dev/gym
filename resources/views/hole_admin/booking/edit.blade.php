        ...
        <div class="statbox widget box box-shadow">
            ...
            <form method="post" action="{{route('booking.new_update',$data->id)}}" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <input required type="text" value="{{$data->name_ar}}" name="name_ar" class="form-control" id="name_ar">
                </div>
                <div class="form-group mb-4">
                    <label for="name">{{ __('messages.booking_name_en') }}</label>
                    <input required type="text" value="{{$data->name_en}}" name="name_en" class="form-control" id="name_en">
                </div>
                <div class="form-group mb-4">
                    <label for="email">{{ __('messages.details_easy_ar') }}</label>
                    <input required type="text" value="{{$data->title_ar}}" class="form-control" id="title_ar" name="title_ar">
                </div>
                <div class="form-group mb-4">
                    <label for="email">{{ __('messages.details_easy_en') }}</label>
                    <input required type="text" value="{{$data->title_en}}" class="form-control" id="title_en" name="title_en">
                </div>
                <div class="form-group mb-4">
                    <label for="email">{{ __('messages.price') }}</label>
                    <input required type="number" value="{{$data->price}}" step="any" class="form-control" id="txt_price" name="price">
                </div>
                <div class="form-group mb-4">
                    <label for="email">{{ __('messages.bookng_month_num') }}</label>
                    <input required type="number" value="{{$data->months_num}}" min="1" class="form-control" id="txt_months_num" name="months_num">
                </div>
