                            ...
                            <div id="defaultAccordionOne" class="collapse" aria-labelledby="..."
                                ...
                                <div class="card-body">
                                    <div class="form-group mb-4">
                                        <img
                                            src="{{image_cloudinary_url()}}{{$data['setting']['logo']}}">
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input required type="phone" name="fax" class="form-control" id="app_phone"
                                               placeholder="{{ __('messages.fax') }}"
                                               value="{{$data['setting']['fax']}}">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="app_phone">{{ __('messages.post_address') }}</label>
                                        <input required type="text" name="post_address" class="form-control"
                                               id="post address"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="instegram" class="form-control" id="instegram"
                                               placeholder="{{ __('messages.instegram') }}"
                                               value="{{$data['setting']['instegram']}}">
                                    </div>
                                    <div class="form-group mb-4">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="watsapp" class="form-control" id="snap_chat"
                                               placeholder="{{ __('messages.watsapp') }}"
                                               value="{{$data['setting']['watsapp']}}">
                                    </div>
                                    <div class="form-group mb-4">
                                        <label for="map_url">{{ __('messages.map_url') }}</label>
                                        <input type="text" name="map_url" class="form-control" id="map_url"
                                               placeholder="{{ __('messages.map_url') }}"
                                               value="{{$data['setting']['map_url']}}">
                                    </div>
                                    <div class="form-group mb-4">
