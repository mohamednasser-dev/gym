        ...
        <div class="statbox widget box box-shadow">
            ...
            <form action="{{route('plans.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mb-4">
                    ...
                    <input required type="number" name="ads_count" class="form-control" id="ads_count"
                           placeholder="{{ __('messages.ads_count') }}" value="">
                </div>
                <div class="form-group mb-4">
                    ...
                    <input required type="number" name="price" class="form-control" id="plan_price" step="any" min="0"
                           placeholder="{{ __('messages.plan_price') }}" value="">
                </div>
