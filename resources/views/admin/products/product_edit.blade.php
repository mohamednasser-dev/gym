            ...
            <div class="widget-header">
                ...
                <form method="post" enctype="multipart/form-data" action="">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input required type="text" name="title" value="{{$data->title}}" class="form-control"
                               id="title"
                    ...
                    <div class="form-group" id="brand_cont">
                        ...
                        <select required class="form-control" name="brand_id" id="cmb_brand_id">
                            ...
                            @if(is_int((int)$selected_brand->target_id))
                                ...
                                @endforeach
                            @else
                                <option value="{{ $selected_brand->target_id }}"
                                        selected>{{ $selected_brand->target_id }}</option>
                            @endif
                        </select>
                    </div>
                    <div class="form-group" id="brand_types_cont">
                        ...
                        <select required class="form-control" name="brand_type_id" id="cmb_brand_types_id">
                            ...
                            @if(is_int((int)$selected_type->target_id))
                                ...
                                @endforeach
                            @else
                                <option value="{{ $selected_type->target_id }}"
                                        selected>{{ $selected_type->target_id }}</option>
                            @endif
                        </select>
                    </div>
                    <div class="form-group" id="model_year_cont">
                        ...
                        <select required class="form-control" name="model_year_id" id="cmb_model_year_id">
                            ...
                            @if(is_int((int)$selected_model_year->target_id))
                                ...
                                @endforeach
                            @else
                                <option value="{{ $selected_model_year->target_id }}"
                                        selected>{{ $selected_model_year->target_id }}</option>
                            @endif
                        </select>
                    </div>
                    <div class="form-group" id="counter_cont">
                        ...
                        <select required class="form-control" name="counter_id" id="cmb_counter_id">
                            @if(is_int((int)$selected_counter->target_id))
                                ...
                                @endforeach
                            @else
                                <option value="{{ $selected_counter->target_id }}"
                                        selected>{{ $selected_counter->target_id }}</option>
                            @endif
                        </select>
                    </div>
                    <div class="form-group mb-4 arabic-direction">
                        ...
                        <textarea required name="description" placeholder="{{ __('messages.product_description') }}"
                                  class="form-control" id="description" rows="5">{{$data->description}}</textarea>
                    </div>
