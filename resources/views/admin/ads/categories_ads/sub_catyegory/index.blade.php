            ...
            <div class="widget-header">
                <div class="row">
                    ...
                    <div class="col-md-6 pl-0 col-sm-6 col-12 text-right">
                        <a href="{{route('sub_categories_ads.create_all',$cat_id)}}" class="btn btn-success mb-2">
                        ...
                        @foreach ($data as $row)
                            <tr>
                                ...
                                <td class="text-center blue-color">
                                    <a href="{{route('sub_two_cat_ads.index',$row->id)}}">
                                        <div class="">
                                ...
                                <td class="text-center blue-color"><a
                                        href="{{ route('sub_categories_ads.show', $row->id) }}">
