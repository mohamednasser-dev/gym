            ...
            <form action="{{route('plans.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input type="checkbox" class="custom-control-input" name="re_post" value="re_post"
                                       id="re_post_id">
                    ...
                    <div class="col-md-3" id="re_post1_cont" style="display:none;">
                        ...
                        <input type="text" name="re_post_title_ar" class="form-control"
                               value="اعادة نشرة فى المكان الاول كل 8 أيام">
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input type="checkbox" class="custom-control-input" name="special" value="special"
                                       id="special_id">
                                <label class="custom-control-label"
