        ...
        <div class="statbox widget box box-shadow">
            ...
            <form action="{{route('plans.update.new',$plan->id)}}" method="post">
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="number" name="day_num" class="form-control" value="{{$plan->day_num}}" id="plan_price"
                           min="0">
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input type="checkbox" @if($plan_repost !=null) checked
                                       @endif class="custom-control-input" name="re_post" value="re_post"
                                       id="re_post_id">
                                <label class="custom-control-label"
                                       for="re_post_id">{{ __('messages.re_post') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3" id="re_post1_cont" @if($plan_repost ==null) style="display:none;"@endif >
                        ...
                        <input type="text" name="re_post_title_ar" class="form-control"
                               @if($plan_repost !=null) value="{{$plan_repost->title_ar}}"@endif >
                    </div>
                    <div class="col-md-3" id="re_post2_cont" @if($plan_repost ==null) style="display:none;"@endif >
                        ...
                        <input type="text" name="re_post_title_en" class="form-control"
                               @if($plan_repost !=null) value="{{$plan_repost->title_en}}"@endif >
                    </div>
                    <div class="col-md-3" id="re_post3_cont" @if($plan_repost ==null) style="display:none;"@endif >
                        ...
                        <input type="number" name="re_post_days" class="form-control"
                               @if($plan_repost !=null) value="{{$plan_repost->expire_days}}" @endif  min="0">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input type="checkbox" @if($plan_pin !=null) checked
                                       @endif  class="custom-control-input" name="pin" value="pin" id="pin_id">
                    ...
                    <div class="col-md-3" id="pin_it1_cont" @if($plan_pin ==null) style="display:none;"@endif >
                        <label for="plan_price">{{ __('messages.name_ar') }}</label>
                        <input type="text" name="pin_it_title_ar" class="form-control"
                               @if($plan_pin !=null) value="{{$plan_pin->title_ar}}"@endif >
                    </div>
                    <div class="col-md-3" id="pin_it2_cont" @if($plan_pin ==null) style="display:none;"@endif >
                        <label for="plan_price">{{ __('messages.name_en') }}</label>
                        <input type="text" name="pin_it_title_en" class="form-control"
                               @if($plan_pin !=null) value="{{$plan_pin->title_en}}"@endif >
                    </div>
                    <div class="col-md-3" id="pin_it3_cont" @if($plan_pin ==null) style="display:none;"@endif >
                        <label for="plan_price">{{ __('messages.days_num') }}</label>
                        <input type="number" name="pin_it_hours" class="form-control"
                               @if($plan_pin !=null) value="{{$plan_pin->expire_days}}" @endif  min="0">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check pl-0">
                            <div class="custom-control custom-checkbox checkbox-info">
                                <input type="checkbox" @if($plan_special !=null) checked
                                       @endif class="custom-control-input" name="special" value="special"
                                       id="special_id">
                                <label class="custom-control-label"
                                       for="special_id">{{ __('messages.add_to_spicial') }}</label>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3" id="special1_cont" @if($plan_special ==null) style="display:none;"@endif >
                        <label for="plan_price">{{ __('messages.name_ar') }}</label>
                        <input type="text" name="special_title_ar" class="form-control"
                               @if($plan_special !=null) value="{{$plan_special->title_ar}}" @endif >
                    </div>
                    <div class="col-md-3" id="special2_cont" @if($plan_special ==null) style="display:none;"@endif >
                        <label for="plan_price">{{ __('messages.name_en') }}</label>
                        <input type="text" name="special_title_en" class="form-control"
                               @if($plan_special !=null) value="{{$plan_special->title_ar}}" @endif >
                    </div>
                    <div class="col-md-3" id="special3_cont" @if($plan_special ==null) style="display:none;"@endif >
                        <label for="plan_price">{{ __('messages.days_num') }}</label>
                        <input type="number" name="special_hours" class="form-control"
                               @if($plan_special !=null) value="{{$plan_special->expire_days}}" @endif  min="0">
                    </div>
                </div>
